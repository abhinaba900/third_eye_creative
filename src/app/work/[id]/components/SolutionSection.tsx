...
export default function SolutionSection({ data }) {
  ...
  return (
    <div className="bg-black text-white px-[1.25rem] mb-[9.036rem] max-w-7xl mx-auto">
      {/* Header */}
      <div className="text-center mb-[6.25rem]">
        ...
        <p className="mt-[1.5rem] text-gray-300 text-sm md:text-base max-w-xl mx-auto single-page-solution-section-description">
          {data.description}
        </p>
      </div>
